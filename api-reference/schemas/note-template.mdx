...
```json Example
{
  ...
  "children": [],
  "result": "Introduction content goes here..."
}
```
</CodeGroup>
...
<ResponseField name="TextSection" type="Object">
  <Expandable title="properties">
    ...
    <ResponseField name="properties" type="Object" required>
      <Expandable title="properties">
        <ResponseField name="allow_bold" type="boolean">
          Whether bold text is allowed in this content.
        </ResponseField>
        <ResponseField name="allow_italic" type="boolean">
          Whether italic text is allowed in this content.
        </ResponseField>
        <ResponseField name="bold" type="boolean">
          Whether the content is bold.
        </ResponseField>
        ...
        <ResponseField name="detail_level" type="string">
          Detail depth of text. One of: "exhaustive", "detailed", "standard", "brief", "minimal". Default: "standard".
        </ResponseField>
        ...
        <ResponseField name="tone" type="string">
          Tone of the text. One of: "formal", "casual", "technical", "friendly", "instructional". Default: "formal".
        </ResponseField>
      </Expandable>
    </ResponseField>
    <ResponseField name="result" type="string">
...
```json Example
{
  ...
  "result": "Our project aims to streamline operations..."
}
```
</CodeGroup>
...
<ResponseField name="ListSection" type="Object">
  <Expandable title="properties">
    ...
    <ResponseField name="properties" type="Object" required>
      <Expandable title="properties">
        <ResponseField name="allow_bold" type="boolean">
          Whether bold text is allowed in list items.
        </ResponseField>
        <ResponseField name="allow_italic" type="boolean">
          Whether italic text is allowed in list items.
        </ResponseField>
        <ResponseField name="bold" type="boolean">
          Whether the content is bold.
        </ResponseField>
        <ResponseField name="detail_level" type="string">
          Detail depth for list items. One of: "high", "medium", "low".
        </ResponseField>
        <ResponseField name="emptyPlaceholder" type="string">
        ...
        <ResponseField name="tone" type="string">
          Tone of the list content. One of: "formal", "casual", "technical", "simple".
        </ResponseField>
      </Expandable>
    </ResponseField>
...
```json Example
{
  ...
  "result": ["Deliverable A", "Deliverable B"]
}
```
</CodeGroup>
