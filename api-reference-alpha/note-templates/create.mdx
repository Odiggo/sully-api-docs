...
description: "Generate a custom note template by analyzing provider notes to identify common patterns and structures."
---
...
Note template generation is an asynchronous process that typically takes:
- **Simple templates** (1-2 notes): 30-60 seconds
- **Complex templates** (3-5 notes): 1-3 minutes
